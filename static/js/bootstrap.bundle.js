...
(function (global, factory) {
  ...
  function getWindowScrollBarX(element) {
    // If <template> has a CSS width greater than the viewport, then this will be
    // incorrect for RTL.
    // Popper 1 is broken in this case and never had a bug report so let's assume
    // it's not an issue. I don't think anyone ever specifies width on <template>
    // anyway.
  ...
  function getViewportRect(element) {
    ...
    // Also, `template.clientHeight` adds the bottom bar height in Safari iOS, even
  ...
  // of the `<template>` and `<body>` rect bounds if horizontally scrollable
